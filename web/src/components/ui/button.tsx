  ...
  ),
  {
    variants: {
      variant: {
        ...
        secondary:
          "border-2 border-black bg-secondary text-secondary-foreground shadow-md transition duration-200 hover:translate-y-1 hover:bg-secondary/90 hover:shadow active:translate-x-1 active:translate-y-2 active:shadow-none",
        destructive:
        ...
        outline:
          "border-2 border-black bg-transparent shadow-md transition duration-200 hover:translate-y-1 hover:bg-accent hover:shadow active:translate-x-1 active:translate-y-2 active:shadow-none",
